...
def sections_single_call():
	...
	lesson_tags = st.text_area("Enter Lesson Tags (Learning Objectives):", value=st.session_state.lesson_tags, height=150, max_chars=10000)
	st.session_state.lesson_tags = lesson_tags
	lesson_title = st.text_area("Lesson Title:", value=st.session_state.lesson_title, max_chars=10000,  height=150)
	st.session_state.lesson_title = lesson_title
	lesson_notes = st.text_area("Lesson Notes:", value=st.session_state.lesson_notes, height=400, max_chars=30000)
	st.session_state.lesson_notes = lesson_notes
	additional_prompts = st.text_area("Additional Prompts/Instructions:", value=st.session_state.additional_prompts, height=400, max_chars=30000)
