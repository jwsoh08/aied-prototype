...
def chatbot_settings():
	if st.checkbox("Use Default ACP Settings", key = 1):
		...
		st.session_state.default_presence_penalty = ACP_CONFIG['default_presence_penalty']
		st.session_state.default_frequency_penalty = ACP_CONFIG['default_frequency_penalty']	
