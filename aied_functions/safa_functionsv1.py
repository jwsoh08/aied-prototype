...
def short_answer(json_call):
	...
	if st.checkbox("Rubrics"):
		...
		st.session_state.rubrics_prompt, total_marks = create_rubric_interface()			
		final_rubrics = st.text_area("Enter your rubrics:", value=st.session_state.rubrics_prompt, max_chars=10000, height=300)
	...
	if question and suggested_answer and total_marks:
		...
		prompt_design = st.text_area("Edit or Enter your prompt design:", value=complete_prompt, max_chars=10000, height=300)
	else:
