...
ACP_CONFIG = config_handler.get_config_values('menu_lists', 'SAFA_CONFIG')
...
def components_single_call():
	...
	st.session_state.section_tags  = st.text_area("Enter Section Tags (Learning Objectives):", value=st.session_state.section_tags,  height=150, max_chars=10000)
	st.session_state.activity_title = st.text_area("Activity Title:", value=st.session_state.activity_title, max_chars=10000,  height=150)
	st.session_state.activity_notes = st.text_area("Activity Notes:", value=st.session_state.activity_notes, height=400, max_chars=30000)
	st.session_state.component_additional_prompts = st.text_area("Additional Prompts/Instructions:", value=st.session_state.component_additional_prompts, height=400, max_chars=30000)
	st.session_state.knowledge_base = st.text_area("Knowledge Base:", value=st.session_state.knowledge_base, height=400, max_chars=30000)
